...
if ( ! is_user_logged_in() ) {
	...
	wp_die(
		__( 'You must be logged in to run this script.', 'toolbar-extras-givewp' ),
		__( 'Toolbar Extras for Give Donations', 'toolbar-extras-givewp' ),
...
if ( ! current_user_can( 'install_plugins' ) ) {
	...
	wp_die(
		__( 'You do not have permission to run this script.', 'toolbar-extras-givewp' ),
		__( 'Toolbar Extras for Give Donations', 'toolbar-extras-givewp' ),
		array( 'back_link' => TRUE )
	);
 ...
 * @uses delete_option()
 */
function ddw_tbexgive_delete_options_transients() {

	/** Delete all options */
	delete_option( 'tbex-options-givewp' );
	delete_option( 'tbexgive-addon-version' );
...
if ( function_exists( 'is_multisite' ) && is_multisite() ) {
	...
	if ( function_exists( 'get_sites' ) && class_exists( 'WP_Site_Query' ) ) {
		...
		foreach ( $site_ids as $site_id ) {
			...
			ddw_tbexgive_delete_options_transients();
